...
function MOD:UpdateInCombatBar()
	if MOD.RequiresMinExpansion(LE_EXPANSION_MISTS_OF_PANDARIA) and C_PetBattles.IsInBattle() then MOD:HideInCombatBar() return end -- hide when entering pet battles
